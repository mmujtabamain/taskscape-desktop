...
| **mini window**              | The compact popup the tray shows under the menu-bar icon ([tray_src/src/app/mini.rs](../tray_src/src/app/mini.rs)).                  |
...
| **`t_*` widgets**            | The reusable themed Iced builders in `common::widgets` (e.g. `t_button`, `t_input_box`).                                             |
